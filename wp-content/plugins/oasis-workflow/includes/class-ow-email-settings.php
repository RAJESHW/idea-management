        ...
        <div id="workflow-email-setting">
            <div id="settingstuff">
                <div class="select-info">
                    ...
                    <input type="text" class="regular-text" name="<?php echo $this->ow_email_option_name?>[from_name]" value="<?php echo $email_options['from_name']; ?>" />
                    <br/>
                ...
                <div class="select-info">
                    ...
                    <input type="text" class="regular-text" name="<?php echo $this->ow_email_option_name?>[from_email_address]" value="<?php echo $email_options['from_email_address']; ?>" />
                    <br/>
                ...
                <fieldset class="owf_fieldset">
                    ...
                    <div class="select-info">
                        ...
                        <input type="text" size="4" class="reminder_days" id="<?php echo $this->ow_email_reminder_day_before_option_name?>" name="<?php echo $this->ow_email_reminder_day_before_option_name?>" value="<?php echo $email_reminder_days_before_option; ?>" maxlength=2 />
                    ...
                    <div class="select-info">
                        ...
                        <input type="text" size="4" class="reminder_days" id="<?php echo $this->ow_email_reminder_day_after_option_name?>" name="<?php echo $this->ow_email_reminder_day_after_option_name?>" value="<?php echo $email_reminder_days_after_option; ?>" maxlength=2 />
